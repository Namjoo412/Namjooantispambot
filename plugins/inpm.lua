...
local name_log = user_print_name(msg.from)
	...
	if matches[1] == 'help' and msg.to.type == 'user' or matches[1] == 'pmhelp' and is_admin1(msg) and msg.to.type ~= 'user' then
		...
		text = "Welcome to Robot!\n\nThis is a bot run by @EUNJOO712 for managing the official group @Namjooantispambot on Telegram\n\nCheck out our channel @eunji_Iran\n\nAlso join To Group Support\n\nhttps://telegram.me/joinchat/EYtAt0AZX8XwLzZZ9YC_7A for knowing more!"
     	return text
    end
